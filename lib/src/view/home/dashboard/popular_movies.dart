...
class PopularMovies extends StatelessWidget {
  ...
  Widget _buildBody(BuildContext context) {
    return Obx(() => movieDetailsController.loadingPopularMovies.value
        ? Padding(
      ...
      child: ListView.builder(
        itemCount: movieDetailsController.popularMovies.value.results!.length,
        shrinkWrap: true,
        physics: NeverScrollableScrollPhysics(),
        itemBuilder: (context, index) {
          Results movie =
          movieDetailsController.popularMovies.value.results![index];
